export declare const VsAlert: import("vuesax-alpha/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    readonly color: {
    ...
    alertStyles: import("vue").ComputedRef<import("vue").CSSProperties>;
