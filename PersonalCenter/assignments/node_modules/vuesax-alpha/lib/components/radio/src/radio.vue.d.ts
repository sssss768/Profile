declare const _default: import("vue").DefineComponent<{
    ...
    props: import("@vue/shared").LooseRequired<{
        ...
        readonly label: import("vuesax-alpha/es/utils").VsPropMergeType<(BooleanConstructor | NumberConstructor | StringConstructor)[], unknown, unknown>;
        readonly name: string;
        readonly loading: import("vuesax-alpha/es/utils").VsPropMergeType<BooleanConstructor, unknown, unknown>;
        readonly value: import("vuesax-alpha/es/utils").VsPropMergeType<(BooleanConstructor | NumberConstructor | StringConstructor)[], unknown, unknown>;
        readonly labelBefore: import("vuesax-alpha/es/utils").VsPropMergeType<BooleanConstructor, unknown, unknown>;
    ...
    uid: import("vue").Ref<string>;
    isDisabled: import("vue").ComputedRef<import("vuesax-alpha/es/utils").VsPropMergeType<BooleanConstructor, unknown, unknown>>;
    loading: import("vue").Ref<import("vuesax-alpha/es/utils").VsPropMergeType<BooleanConstructor, unknown, unknown>>;
    model: import("vue").WritableComputedRef<import("vuesax-alpha/es/utils").VsPropMergeType<(BooleanConstructor | NumberConstructor | StringConstructor)[], unknown, unknown>>;
    focus: import("vue").Ref<boolean>;
    checked: import("vue").ComputedRef<boolean>;
    color: import("vue").ComputedRef<import("../../..").Color | undefined>;
    vsBaseClasses: string[];
    radioKls: import("vue").ComputedRef<(string | string[])[]>;
    radioStyles: import("vue").ComputedRef<Record<string, string>[]>;
    ...
    label: import("vuesax-alpha/es/utils").VsPropMergeType<(BooleanConstructor | NumberConstructor | StringConstructor)[], unknown, unknown>;
    name: string;
    loading: import("vuesax-alpha/es/utils").VsPropMergeType<BooleanConstructor, unknown, unknown>;
    value: import("vuesax-alpha/es/utils").VsPropMergeType<(BooleanConstructor | NumberConstructor | StringConstructor)[], unknown, unknown>;
    labelBefore: import("vuesax-alpha/es/utils").VsPropMergeType<BooleanConstructor, unknown, unknown>;
}, {}>;
