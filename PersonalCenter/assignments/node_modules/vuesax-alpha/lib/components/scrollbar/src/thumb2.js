...
const _sfc_main = vue.defineComponent({
  ...
  setup(__props) {
    ...
    const offsetRatio = vue.computed(
      () => instance.value[bar.value.offset] ** 2 / scrollbar$1.wrapElement[bar.value.scrollSize] / props.ratio / thumb.value[bar.value.offset]
    );
    ...
    const clickTrackHandler = (e) => {
      if (!thumb.value || !instance.value || !scrollbar$1.wrapElement)
        return;
      scrollbar$1.wrapElement.style.scrollBehavior = "smooth";
      ...
      scrollbar$1.wrapElement.style.scrollBehavior = "unset";
    };
    const startDrag = (e) => {
    ...
    core.useEventListener(
      vue.toRef(scrollbar$1, "scrollbarElement"),
      "mousemove",
...
var Thumb = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "/home/runner/work/vuesax-alpha/vuesax-alpha/packages/components/scrollbar/src/thumb.vue"]]);
