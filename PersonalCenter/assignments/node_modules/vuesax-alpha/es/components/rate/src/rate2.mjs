import { defineComponent, ref, computed, markRaw, watch, openBlock, createElementBlock, normalizeClass, unref, normalizeStyle, Fragment, renderList, createVNode, withCtx, withDirectives, createBlock, resolveDynamicComponent, vShow, createCommentVNode, toDisplayString } from 'vue';
...
const _hoisted_1 = ["aria-label", "aria-valuenow", "aria-valuetext", "aria-valuemax"];
...
var Rate = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/runner/work/vuesax-alpha/vuesax-alpha/packages/components/rate/src/rate.vue"]]);
