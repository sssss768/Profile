export declare const VsPagination: import("vuesax-alpha/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    readonly color: {
    ...
    readonly layout: import("vuesax-alpha/es/utils").VsPropFinalized<(new (...args: any[]) => (("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes") | ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes")[]) & {}) | (() => ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes") | ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes")[]) | ((new (...args: any[]) => (("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes") | ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes")[]) & {}) | (() => ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes") | ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes")[]))[], unknown, unknown, () => ["prev", "pager", "next", "jumper", "->", "total", "slot", "sizes"], boolean>;
    ...
    readonly layout: import("vuesax-alpha/es/utils").VsPropMergeType<(new (...args: any[]) => (("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes") | ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes")[]) & {}) | (() => ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes") | ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes")[]) | ((new (...args: any[]) => (("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes") | ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes")[]) & {}) | (() => ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes") | ("slot" | "total" | "prev" | "pager" | "next" | "jumper" | "->" | "sizes")[]))[], unknown, unknown>;
