<template>
  ...
  <el-form v-if="isLoginForm" ref="LoginForm" style="max-width: 600px" :model="loginForm" status-icon
    :rules="loginRules" label-width="auto" class="Form">
  ...
  <el-form v-else ref="FormRef" style="max-width: 600px" :model="Form" status-icon :rules="rules" label-width="auto"
    class="Form">
    ...
    <el-form-item>
      <el-button type="text" @click="switchForm" style="margin-left: 15em;">返回登录</el-button>
    </el-form-item>
  </el-form>
</template>
